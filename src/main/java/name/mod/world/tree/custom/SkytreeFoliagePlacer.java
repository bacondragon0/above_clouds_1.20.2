package name.mod.world.tree.custom;
import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import name.mod.world.tree.ModFoliagePlacerTypes;
...
public class SkytreeFoliagePlacer extends FoliagePlacer {
    public static final Codec<SkytreeFoliagePlacer> CODEC = RecordCodecBuilder.create(chestnutFoliagePlacerInstance ->
            fillFoliagePlacerFields(chestnutFoliagePlacerInstance).and(Codec.intRange(0, 12).fieldOf("height")
                    .forGetter(instance -> instance.height)).apply(chestnutFoliagePlacerInstance, SkytreeFoliagePlacer::new));
    private final int height;

    public SkytreeFoliagePlacer(IntProvider radius, IntProvider offset, int height) {
        super(radius, offset);
        this.height = height;
    }
    ...
    protected FoliagePlacerType<?> getType() {
        return ModFoliagePlacerTypes.SKYTREE_FOLIAGE_PLACER;
    }
