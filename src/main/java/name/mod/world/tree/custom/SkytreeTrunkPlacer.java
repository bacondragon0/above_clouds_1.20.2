...
import name.mod.world.tree.ModTrunkPlacerTypes;
...
public class SkytreeTrunkPlacer extends TrunkPlacer {
    public static final Codec<SkytreeTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, SkytreeTrunkPlacer::new));

    public SkytreeTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerTypes.SKYTREE_TRUNK_PLACER;
    }
